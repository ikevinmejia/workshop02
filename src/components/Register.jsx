...
const Register = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const cuenta = {
            ...
            phone,
            user,
            imgProfile: "https://res.cloudinary.com/dzsd7vfjr/image/upload/v1659126463/original_gbhxsu.jpg",
    ...
    return (
        <div className='container flex flex-col justify-center'>
            ...
            <form onSubmit={(e) => handleSubmit(e)} className='flex flex-col justify-center p-10 pt-20'>
                <h1 className='mb-5 text-3xl font-medium text-center' style={{ color: "#FF7674" }}>Register</h1>
                ...
                <div className="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div className="relative z-0 w-full mb-6 group">
                        <input type="text" name="floating_company" id="floating_company" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required="" value={user} onChange={(e) => setUser(e.target.value)} />
